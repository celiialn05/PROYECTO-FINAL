<?php
/**
 * Este archivo PHP maneja las solicitudes relacionadas con la inserción de registros de estadísticas.
 * Proporciona un endpoint para insertar un nuevo registro de estadísticas en la base de datos.
 *
 */
